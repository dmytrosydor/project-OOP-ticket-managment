...
public:
    ...
    QLabel *label_6;
    QComboBox *cmbChooseDestination;
    QLabel *label_4;
    QLabel *label;
    ...
    QTextEdit *txtTicketDescription;
    QPushButton *btnSave;
    ...
    void setupUi(QDialog *AddPerson)
    {
        ...
        formLayoutWidget->setGeometry(QRect(50, 20, 471, 311));
        ...
        cmbChooseDestination = new QComboBox(formLayoutWidget);
        cmbChooseDestination->setObjectName("cmbChooseDestination");

        gridLayout->addWidget(cmbChooseDestination, 6, 1, 1, 1);
        ...
        txtTicketDescription = new QTextEdit(formLayoutWidget);
        txtTicketDescription->setObjectName("txtTicketDescription");

        gridLayout->addWidget(txtTicketDescription, 7, 1, 1, 1);
    ...
    void retranslateUi(QDialog *AddPerson)
    {
        ...
        label_7->setText(QCoreApplication::translate("AddPerson", "Choose destination", nullptr));
