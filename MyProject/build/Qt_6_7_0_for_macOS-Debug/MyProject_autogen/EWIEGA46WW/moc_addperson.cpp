...
constexpr auto qt_meta_stringdata_CLASSAddPersonENDCLASS = QtMocHelpers::stringData(
    "AddPerson",
    "on_btnSave_clicked",
    "",
    "on_btnReset_clicked",
    "on_loadPackage_clicked",
    "on_cmbChooseDestination_currentIndexChanged",
    "index"
);
...
Q_CONSTINIT const QMetaObject AddPerson::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAddPersonENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_loadPackage_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_cmbChooseDestination_currentIndexChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void AddPerson::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_loadPackage_clicked(); break;
        case 3: _t->on_cmbChooseDestination_currentIndexChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
